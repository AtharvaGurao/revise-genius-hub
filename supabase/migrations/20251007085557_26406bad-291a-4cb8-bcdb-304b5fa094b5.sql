-- Move tables from app schema to public schema with better names
-- Drop the app schema tables and recreate in public

-- First, drop the app schema view and tables
DROP VIEW IF EXISTS app.progress_summary;
DROP TABLE IF EXISTS app.answers CASCADE;
DROP TABLE IF EXISTS app.attempts CASCADE;
DROP SCHEMA IF EXISTS app CASCADE;

-- Create quiz_attempts table in public schema
...
-- Create quiz_answers table in public schema
...
-- RLS Policies for quiz_attempts_v2
...
-- Create progress_summary view in public schema
...
-- Enable realtime for quiz_attempts_v2 table
